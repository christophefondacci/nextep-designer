...
public class VersionCompareHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (s instanceof IStructuredSelection) {
			...
			if (mainVersion != null) {
				final IVersionInfo sourceVersion = otherVersion == null ? mainVersion
						.getPreviousVersion() : otherVersion;
				VCSUIPlugin.getComparisonUIManager().compare(mainVersion.getReference(),
						mainVersion, sourceVersion);
			}
		}
