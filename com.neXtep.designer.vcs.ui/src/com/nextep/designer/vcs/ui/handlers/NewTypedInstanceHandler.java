 ...
 */
public class NewTypedInstanceHandler extends AbstractHandler {

	private static final Log log = LogFactory.getLog(NewTypedInstanceHandler.class);

	/**
	 * The constructor.
	 */
	public NewTypedInstanceHandler() {
	}
