...
/**
 * A typed factory providing Oracle-specific table physical properties implementation
 * 
 * @author Christophe Fondacci
 */
public class OracleTablePhysicalPropertiesFactory implements ITypedObjectFactory {

	@SuppressWarnings("unchecked")
	@Override
	public <T extends ITypedObject> T create(Class<T> classToCreate) {
		return (T) new OracleTablePhysicalProperties();
	}
