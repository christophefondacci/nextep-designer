...
/**
 * A typed factory providing Oracle-specific index physical properties implementation
 * 
 * @author Christophe Fondacci
 */
public class OracleIndexPhysicalPropertiesFactory implements ITypedObjectFactory {

	@SuppressWarnings("unchecked")
	@Override
	public <T extends ITypedObject> T create(Class<T> classToCreate) {
		return (T) new OracleIndexPhysicalProperties();
	}
