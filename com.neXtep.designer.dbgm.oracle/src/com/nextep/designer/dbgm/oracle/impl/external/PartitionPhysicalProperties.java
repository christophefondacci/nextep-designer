 ...
 */
public class PartitionPhysicalProperties extends AbstractOraclePhysicalProperties implements
		IPartitionPhysicalProperties {

	/** Parent partition */
	private IPhysicalObject partition;
