...
import com.nextep.designer.dbgm.mysql.ui.impl.MySQLIndexEditor;
import com.nextep.designer.dbgm.ui.controllers.IndexUIController;

public class MySQLIndexController extends IndexUIController {

	@Override
	public IDisplayConnector initializeEditor(Object content) {
		return new MySQLIndexEditor((IMySQLIndex) content, this);
	}
