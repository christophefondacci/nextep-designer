 ...
 * $Id$
 */
package com.nextep.designer.diagram.model.provider;
...
/**
 * This is the item provider adapter for a {@link com.nextep.designer.diagram.model.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.TABLE__COLUMNS);
			childrenFeatures.add(ModelPackage.Literals.TABLE__SOURCE_CONSTRAINTS);
			childrenFeatures.add(ModelPackage.Literals.TABLE__TARGET_CONSTRAINT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.TABLE__COLUMNS,
				 ModelFactory.eINSTANCE.createColumn()));

		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.TABLE__SOURCE_CONSTRAINTS,
				 ModelFactory.eINSTANCE.createConstraint()));

		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.TABLE__TARGET_CONSTRAINT,
				 ModelFactory.eINSTANCE.createConstraint()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == ModelPackage.Literals.TABLE__SOURCE_CONSTRAINTS ||
			childFeature == ModelPackage.Literals.TABLE__TARGET_CONSTRAINT;
	...
	public ResourceLocator getResourceLocator() {
		return DbmodelEditPlugin.INSTANCE;
	}
