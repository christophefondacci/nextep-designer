...
import com.nextep.designer.dbgm.postgre.model.impl.PostgreSqlInheritedTable;

/**
 * @author Christophe Fondacci
 */
public class PostgreSqlInheritedTableFactory implements ITypedObjectFactory {

	@Override
	public <T extends ITypedObject> T create(Class<T> classToCreate) {
		return (T) new PostgreSqlInheritedTable();
	}
