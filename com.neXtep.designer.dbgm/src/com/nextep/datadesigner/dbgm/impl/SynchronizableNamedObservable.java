 ...
 *
 */
public class SynchronizableNamedObservable extends IDNamedObservable implements ISynchronizable {

	SynchStatus synched = SynchStatus.UNKNOWN;
	/**
...
//		this.notifyListeners(ChangeEvent.SYNCH_STATUS_CHANGED, synched);
	}
