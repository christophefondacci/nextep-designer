...
import com.nextep.designer.dbgm.model.impl.CheckConstraint;

/**
 * @author Christophe Fondacci
 */
public class CheckConstraintFactory implements ITypedObjectFactory {

	@SuppressWarnings("unchecked")
	@Override
	public <T extends ITypedObject> T create(Class<T> classToCreate) {
		return (T) new CheckConstraint();
	}
