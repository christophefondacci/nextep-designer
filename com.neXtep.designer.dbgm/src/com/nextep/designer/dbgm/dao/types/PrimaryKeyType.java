 ...
 *******************************************************************************/
package com.nextep.designer.dbgm.dao.types;
 ...
 */
public class PrimaryKeyType implements UserType {
	...
	public Object nullSafeGet(ResultSet rs, String[] names, Object owner)
		...
		if (value != null) {
			return "Y".equals(value) ? ConstraintType.PRIMARY : ConstraintType.UNIQUE; //$NON-NLS-1$
		}
		return null;
	}
	...
	public void nullSafeSet(PreparedStatement st, Object value, int index)
		...
		if (value == null) {
			...
			st.setString(index, value == ConstraintType.PRIMARY ? "Y" : "N"); //$NON-NLS-1$ //$NON-NLS-2$
		}
