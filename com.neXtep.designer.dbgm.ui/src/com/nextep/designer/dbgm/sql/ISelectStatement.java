...
//
///**
// * The interface represents a select statement.
// * It provides methods for a 2-way SQL manipulation:<br>
// *  - Setting the SQL with the get / set SQL methods to parse
// *  the SQL will let the user extract statement information.<br>
// *  <br>
// *  - Manipulating the statement by adding / removing elements with
// *  the API provided by this interface and retrieve a SQL representation
// *  of the statement with the <code>getSQL()</code> method.
// * <br><br>
// * This interface should not be implemented directly. Clients should
// * use the AbstractSelectStatement as a base for extension.
// * 
// * @author Christophe Fondacci
// *
// */
//public interface ISelectStatement extends IObservable {
//
//	/**
...
//	/**
//	 * @return the string representation of the SQL statement
//	 */
//	public String getSQL();
//	/**
//	 * @return the tables appearing in the FROM clause of the
//	 * 		   SQL statement.
//	 */
