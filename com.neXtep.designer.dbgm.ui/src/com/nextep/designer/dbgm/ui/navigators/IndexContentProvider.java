...
public class IndexContentProvider implements ITreeContentProvider, IEventListener {

	@Override
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof ITypedNode) {
			return ((ITypedNode) parentElement).getChildren().toArray();
		} else if (parentElement instanceof IIndex) {
			final Collection<Object> elts = new ArrayList<Object>();
			final IIndex index = (IIndex) parentElement;
			elts.addAll(index.getColumns());
			return TypedNode.buildNodesFromCollection(index,
	...
	public boolean hasChildren(Object element) {
		if (element instanceof ITypedNode) {
			return true;
		} else if (element instanceof IIndex) {
			return true;
		}
		return false;
	}
