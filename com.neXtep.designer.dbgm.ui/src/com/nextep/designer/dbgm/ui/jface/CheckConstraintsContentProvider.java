 ...
 */
public class CheckConstraintsContentProvider implements IStructuredContentProvider, IEventListener,
		IModelOriented<ICheckConstraintContainer> {

	private ICheckConstraintContainer parent;
	...
	public void inputChanged(Viewer viewer, Object oldInput, Object newInput) {
		...
		this.viewer = viewer;
		if (newInput instanceof ICheckConstraintContainer) {
			parent = (ICheckConstraintContainer) newInput;
	...
	public Object[] getElements(Object inputElement) {
		for (ICheckConstraint c : parent.getCheckConstraints()) {
			bindListener(c);
		}
		return parent.getCheckConstraints().toArray();
	}
	...
	@Override
	public void setModel(ICheckConstraintContainer model) {
		inputChanged(viewer, parent, model);
		viewer.refresh();
	}

	@Override
	public ICheckConstraintContainer getModel() {
		return parent;
	}
