...
/**
 * A simple wrapper around a constraint provider setup for a UNIQUE key constraint type. The only
 ...
 */
public class UniqueKeyContentProvider implements IStructuredContentProvider {

	private IStructuredContentProvider constraintProvider;

	public UniqueKeyContentProvider() {
		constraintProvider = new ConstraintsContentProvider(ConstraintType.UNIQUE,
