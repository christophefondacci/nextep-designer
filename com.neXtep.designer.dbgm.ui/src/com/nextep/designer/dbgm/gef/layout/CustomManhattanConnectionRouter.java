 ...
 * and target anchors.
 */
public final class CustomManhattanConnectionRouter
...
protected PointList processPositions(Ray start, Ray end, List positions, 
...
public void route(Connection conn) {
	if ((conn.getSourceAnchor() == null) || (conn.getTargetAnchor() == null)) 
		return;
	conn.setPoints(routeFromTo(getStartPoint(conn), getEndPoint(conn), conn));
	
}
public PointList routeFromTo(Point startPoint,Point endPoint, Connection conn) {
	...
	return processPositions(start, end, positions, startNormal.isHorizontal(), conn);
}
