...
/**
 * Navigator for {@link IDomain}
 * @author Christophe Fondacci
 */
public class DomainNavigator extends TypedNavigator {

	public DomainNavigator(IDomain domain, ITypedObjectUIController controller) {
		super(domain,controller);
	}
	@Override
	public void initializeChildConnectors() {
		super.initializeChildConnectors();
		IDomain d = (IDomain)getModel();
//		for(IDomainVendorType t : d.getVendorTypes()) {
//			
//		}
	}
	@Override
