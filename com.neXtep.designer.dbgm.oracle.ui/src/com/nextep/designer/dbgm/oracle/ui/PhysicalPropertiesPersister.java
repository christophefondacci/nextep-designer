 ...
 *
 */
public class PhysicalPropertiesPersister extends TypePersister {

	public static final String FACTORY_ID = "com.neXtep.designer.dbgm.oracle.ui.PhysicalPropertiesFactory";
	/**
	 * @see com.nextep.datadesigner.vcs.gui.external.TypePersister#getPersistableClass()
	 */
	@Override
	protected Class<?> getPersistableClass() {
		return OracleTablePhysicalProperties.class;
	}
