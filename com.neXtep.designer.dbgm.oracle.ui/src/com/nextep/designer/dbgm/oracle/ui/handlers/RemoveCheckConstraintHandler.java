 ...
 */
public class RemoveCheckConstraintHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (model instanceof ICheckConstraint) {
			ICheckConstraint c = (ICheckConstraint) model;
			CorePlugin.getService(IWorkspaceUIService.class).remove(c);
		}
		return null;
	}
