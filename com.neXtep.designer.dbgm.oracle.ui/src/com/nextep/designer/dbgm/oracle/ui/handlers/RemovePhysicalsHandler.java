 ...
 */
public class RemovePhysicalsHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (model instanceof IPhysicalProperties) {
			IPhysicalProperties p = (IPhysicalProperties) model;
			CorePlugin.getService(IWorkspaceUIService.class).remove(p);
		}
		return null;
	}
