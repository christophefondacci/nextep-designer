 ...
 */
public class ClusteredTablesContentProvider implements IStructuredContentProvider,
		IModelOriented<IOracleCluster>, IEventListener {

	private IOracleCluster parent;
	...
	public void inputChanged(Viewer viewer, Object oldInput, Object newInput) {
		...
		this.viewer = viewer;
		if (newInput instanceof IOracleCluster) {
			parent = (IOracleCluster) newInput;
	...
	public Object[] getElements(Object inputElement) {
		return parent.getClusteredTables().toArray();
	}

	@Override
	public void handleEvent(ChangeEvent event, IObservable source, Object data) {
		if (source instanceof IOracleCluster) {
			viewer.refresh();
		} else {
	...
	@Override
	public void setModel(IOracleCluster model) {
		inputChanged(viewer, parent, model);
		viewer.refresh();
	}

	@Override
	public IOracleCluster getModel() {
		return parent;
	}
