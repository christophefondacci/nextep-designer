 ...
 *
 */
public class IndexPhysicalPropertiesPersister extends TypePersister {

	public static final String FACTORY_ID = "com.neXtep.designer.dbgm.oracle.ui.IndexPhysicalPropertiesFactory";
	/**
	 * @see com.nextep.datadesigner.vcs.gui.external.TypePersister#getPersistableClass()
	 */
	@Override
	protected Class<?> getPersistableClass() {
		return OracleIndexPhysicalProperties.class;
	}
