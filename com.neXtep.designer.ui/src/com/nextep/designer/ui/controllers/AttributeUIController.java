...
import com.nextep.datadesigner.gui.impl.navigators.AttributeNavigator;
 ...
 */
public class AttributeUIController extends AbstractUIController implements ITypedObjectUIController {
	...
	public INavigatorConnector initializeNavigator(Object model) {
		return new AttributeNavigator((IAttribute) model);
	}
