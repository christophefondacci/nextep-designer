...
/**
 * A marker hint which, when executed, will commit the marked element.
 * 
 * @author Christophe Fondacci
 */
public class CommitHint implements IMarkerHint {

	@Override
	public void execute(Object element) {
		Assert.instanceOf(element, IVersionable.class,
				VCSMessages.getString("hint.commit.nonVersionableError")); //$NON-NLS-1$
	...
	public String getDescription() {
		return VCSMessages.getString("hint.commit.description"); //$NON-NLS-1$
	}
