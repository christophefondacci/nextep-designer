...
public class ParentModuleNameProvider implements INamingVariableProvider {

    public static final String VAR_NAME = "MOD_NAME";

    @Override
    public String getDescription() {
        return VCSMessages.getString("namingVariableProvider.moduleName.description");
    }
