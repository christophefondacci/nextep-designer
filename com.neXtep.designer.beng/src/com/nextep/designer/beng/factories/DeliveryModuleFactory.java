 ...
 *******************************************************************************/
package com.nextep.designer.beng.factories;
...
/**
 * A factory for delivery modules
 * 
 * @author Christophe Fondacci
 */
public class DeliveryModuleFactory implements ITypedObjectFactory {

	@SuppressWarnings("unchecked")
	@Override
	public <T extends ITypedObject> T create(Class<T> classToCreate) {
		return (T) new DeliveryModule();
	}
